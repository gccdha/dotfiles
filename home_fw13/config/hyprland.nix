{ lib, ... }: {
  ...
  services.hyprpaper.settings = {
    wallpaper = [
    {
      fit_mode = "cover";
      monitor = "";
      path = "/home/rr/Pictures/chongqing.jpg";
    }
    ];
  };
  services.gammastep = {
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    on._args = [
      ...
      function()
        ...
        hl.exec_cmd("swaync")
        hl.exec_cmd("zsh /home/rr/.dotfiles/battery_notification/battery_notification.sh")
    ...
    bind = [
      ...
      { _args = [
          ...
          (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"hyprshot -m output -m eDP-1 -o /home/rr/Pictures/Screenshots\")")
      ];}
      { _args = [
          (lib.generators.mkLuaInline "\"SHIFT + Print\"")
          (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"hyprshot -m region -o /home/rr/Pictures/Screenshots\")")
      ];}
